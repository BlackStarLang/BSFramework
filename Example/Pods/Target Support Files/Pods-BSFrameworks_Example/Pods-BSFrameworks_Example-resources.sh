...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_ROOT}/../../BSFrameworks/Assets/PhotoFramework/MMVideoPreviewPlay@2x.png"
  install_resource "${PODS_ROOT}/../../BSFrameworks/Assets/PhotoFramework/MMVideoPreviewPlayHL@2x.png"
  install_resource "${PODS_ROOT}/../../BSFrameworks/Assets/PhotoFramework/navi_back@2x.png"
  ...
  install_resource "${PODS_ROOT}/../../BSFrameworks/Assets/PhotoFramework/photo_def_photoPickerVc@2x.png"
  install_resource "${PODS_ROOT}/../../BSFrameworks/Assets/PhotoFramework/photo_def_previewVc@2x.png"
  install_resource "${PODS_ROOT}/../../BSFrameworks/Assets/PhotoFramework/photo_number_icon@2x.png"
  install_resource "${PODS_ROOT}/../../BSFrameworks/Assets/PhotoFramework/photo_original_def@2x.png"
  install_resource "${PODS_ROOT}/../../BSFrameworks/Assets/PhotoFramework/photo_original_sel@2x.png"
  install_resource "${PODS_ROOT}/../../BSFrameworks/Assets/PhotoFramework/photo_sel_photoPickerVc@2x.png"
  install_resource "${PODS_ROOT}/../../BSFrameworks/Assets/PhotoFramework/photo_sel_previewVc@2x.png"
  install_resource "${PODS_ROOT}/../../BSFrameworks/Assets/PhotoFramework/preview_number_icon@2x.png"
