...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_ROOT}/../../BSFrameworks/Assets/PhotoFramework/photo_camera_back.png"
  ...
  install_resource "${PODS_ROOT}/../../BSFrameworks/Assets/PhotoFramework/photo_camera_next.png"
